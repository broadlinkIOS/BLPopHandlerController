...
Pod::Spec.new do |s|
  ...
  s.version          = '1.1.0'
  s.summary          = 'BLPopHandlerController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/broadlinkIOS/BLPopHandlerController/commits/master'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'upupSue' => 'bigGIfts@163.com' }
  s.source           = { :git => 'https://github.com/broadlinkIOS/BLPopHandlerController.git', :tag => '1.1.0' }
